<?php
	// Page metadata and CSS include for student full ticket view
	$title = 'Ticket status';
	$head = '<link rel="stylesheet" href="/css/student/studentTicketFull.css">';
?>
...
<script src="/js/student/studentTicketFull.js"></script>
