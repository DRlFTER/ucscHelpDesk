<main>
  <div class="fullPage">
    <div class="pageHeader">
      ...
      <p class="pageSubtitle">Overview of your support activity</p>
    </div>
      ...
      <section class="settingsRight">
        <div class="dashboardGrid">
          <div class="col colLeft">
            <div class="card sectionCard welcomeCard">
          <?php
          ...
          <div class="quickActions">
            ...
            <a href="/student/faq" class="quickActionItem">
              <div class="icon">
                <div class="quickActionSvg">
            ...
            <div class="card knowledgeBase sectionCard clickable" role="link" tabindex="0" onclick="window.location.href='/student/knowledgebase'" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();window.location.href='/student/knowledgebase';}">
          ...
          <div class="kbSearch">
            ...
            <div class="card recentTickets sectionCard">
