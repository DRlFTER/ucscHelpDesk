    ...
    <div class="fullPage">
        ...
        <div class="ticketsFilters">
            <div class="search">
              ...
              <input id="userSearch" type="text" placeholder="Search users, email, phone...">
            </div>
            <div class="filters">
                 <select id="typeFilter" aria-label="Type filter"></select>
                 <select id="designationFilter" aria-label="Designation filter"></select>
            </div>
        </div>
