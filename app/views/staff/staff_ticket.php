...
// Fetch tickets (e.g., only assigned to logged-in staff)
...
/* Common filter button & select styling */
.filter-btn {
    appearance: none;           /* removes default browser style for select */
    ...
    color: var(--color-text-dark);
    cursor: pointer;
    min-width: 160px;           /* optional, keeps dropdowns same width */
}
.filter-group label {
  font-size: 12px;
  color: #666;
...
:root {
    ...
    --color-border-medium: #d1d1d4;
    --color-border-strong: #9ca3af;
    --color-border-card: #d7d7d7;
    --color-border-separator: #c5c5c5;

    --status-review-bg: #fff68f;
    --status-review-text: #844d0f;
...
<main id="main-content" class="main-content">
    ...
    <div class="controls-bar">
        ...
        <div class="filters">
            <select id="status-filter" class="filter-btn" value="All statuses">
            ...
            <select id="ticket-filter" class="filter-btn">
      ...
      <div class="ticket-header">
        ...
        <span class="status-badge status-${ticket.status}">
          ...
          <div class="ticket-action">
            <button class="ticket-action-btn" onclick="window.location.href='ticket_page.php?ticket_id=${ticket.ticket_id}'"><span>See Ticket</span></button>
          </div>
      </div>
      <div class="ticket-body">
        <div class="details-group">
          <div class="detail-item">
            ...
            <span class="detail-value-box">${ticket.student_name}</span>
          </div>
          <div class="detail-item">
            <span class="detail-label">Category:</span>
            <span class="detail-value-box">${ticket.category}</span>
          </div>
        </div>
        <div class="details-group separator">
          ...
          <div class="detail-item">
            ...
            <span class="detail-value-box value-priority-${ticket.priority}">
...
<body>
  ...
  <main id="main-content" class="main-content">
    ...
    <div class="tickets-container">
      <!-- JS will inject ticket cards here -->
    </div>
  </main>
</body>
</html>
