...
<head>
    ...
    <style>
        ...
        * {
        ...
        #statusChart, #overdueChart, #staffChart, #escalationChart {
            max-height: 300px;
            margin: 0 auto;
        }
        /* Print Fallback Text */
...
<body>
            ...
            <form method="POST" class="report-filters">
                <div class="filter-item">
                    ...
                    <select name="report_type" id="report_type" required onchange="toggleFilters()">
                        ...
                        <option value="staff_assignment" <?= $report_type == 'staff_assignment' ? 'selected' : '' ?>>Staff Assignments</option>
            ...
            <?php if (!empty($reports)): ?>
                ...
                <div class="report-card">
                    ...
                    <div class="table-container">
                        <?php
                        $col_count = $report_type === 'all_tickets' ? 7 : ($report_type === 'overdue_tickets' ? 6 : ($report_type === 'staff_assignment' ? 4 : 7));
                        ?>
                        ...
                        <table class="report-table" data-cols="<?= $col_count ?>">
                            <thead>
                                <tr>
                                    ...
                                    <?php elseif ($report_type === 'staff_assignment'): ?>
                                        <th>Staff Name</th><th>Email</th><th>Ticket Count</th><th>Status</th>
    ...
    <script>
        ...
        window.addEventListener('beforeprint', function() {
            ...
            if (window.staffChart) window.staffChart.resize();
