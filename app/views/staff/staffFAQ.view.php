  ...
  <div class="fullPage">
    <div class="pageLayout">
      ...
      <div class="search">
        ...
        <input id="staffFaqSearch" type="text" placeholder="Search FAQs..." aria-label="Search FAQs">
      </div>
      <div class="filters">
        <button id="staffNewFaqBtn" class="btnWSvg" type="button">
    ...
    <div id="staffFaqsList" class="tickets" aria-live="polite"></div>
      <div class="ticketsPagination">
        <div class="ticketsPageHolder" id="staffFaqsPagination"></div>
      </div>
    </div>
  </div>
</main>
<div id="staffDeleteFaqModal" class="modalOverlay" aria-hidden="true">
  <div class="msgHolder">
    <div class="msgContainer" role="dialog" aria-modal="true" aria-labelledby="staffDeleteFaqModalTitle">
      <div class="msgContent">
        <h3 id="staffDeleteFaqModalTitle" class="msgTitle">Delete this FAQ?</h3>
        <p class="msgText">This action is permanent and cannot be undone.</p>
        <div class="msgActions">
          <button id="staffCancelDeleteFaqBtn" type="button" class="btnSecondary"><span class="btnSecondaryText">Cancel</span></button>
          <button id="staffConfirmDeleteFaqBtn" type="button" class="btnPrimary btnDanger"><span class="btnPrimaryText">Delete</span></button>
        </div>
      </div>
    </div>
  </div>
...
<div id="staffEditFaqModal" class="modalOverlay" aria-hidden="true">
  <div class="msgHolder">
    <div class="msgContainer" role="dialog" aria-modal="true" aria-labelledby="staffEditFaqModalTitle">
      <div class="msgContent">
        <h3 id="staffEditFaqModalTitle" class="msgTitle">New FAQ</h3>
        <form id="staffFaqForm" class="formGrid">
          <label>
            <span>Question</span>
            <input type="text" id="staffFaqQuestion" name="question" required />
          </label>
          <label>
            <span>Answer</span>
            <textarea id="staffFaqAnswer" name="answer" rows="5" required></textarea>
          </label>
          <div class="msgActions">
            <button type="button" id="staffCancelFaqEditBtn" class="btnSecondary"><span class="btnSecondaryText">Cancel</span></button>
...
<script src="/js/staff/staffFaqs.js"></script>